...
public class Team5Racing extends SimpleBulletApplication implements BindingListener {
    ...
    public static void main(String[] args) {
        Team5Racing app = new Team5Racing();
        app.start();
    }
    ...
    public void onPreUpdate(float tpf) {
        ...
        t5rcam.getJMonkeyCamera().getLocation().interpolate(camNode.getWorldTranslation(), tpf * 2);
        t5rcam.getJMonkeyCamera().lookAt(player.getWorldTranslation(), up);
    }
...
//        Geometry floorGeom = new Geometry("Floor", floor);
        Geometry floorGeom = (Geometry) assetManager.loadModel("Models/TestTrack.obj");
        //floorGeom.move(100f, -20f, -10);
        ...
        tb.setLocalTranslation(new Vector3f(40f, -10f, 10f));
        tb.updateModelBound();
...
//        rootNode.attachChild(geom);
    ...
    private void buildPlayer() {
        ...
        //Create a node for the camera and attach it to the player
        camNode = new Node();
        player.attachChild(camNode);
        camNode.setLocalTranslation(0, 2.5f, 8);
//        Sphere s = new Sphere(6, 6, 1);
//        Geometry g = new Geometry("asd", s);
...
//        camNode.attachChild(g);
    ...
    void setupCamera() {
        ...
        t5rcam = new T5RCamera(
                "MainCamera", settings.getWidth(), settings.getHeight(), 45f,
                renderManager, rootNode, guiNode);
        t5rcam.activate();
        rootNode.attachChild(t5rcam);
    }
}
